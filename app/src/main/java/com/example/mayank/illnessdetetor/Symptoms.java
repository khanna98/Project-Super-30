...
public class Symptoms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_multiple_choice, symlist);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Iterator<Map.Entry<String, Set<String>>> entries = hashMap.entrySet().iterator();
                while(entries.hasNext()) {
                    Map.Entry<String, Set<String>> thisentry = entries.next();
                    for (int i = 0; i < selecteditems.size(); i++) {
                        if (String.valueOf(thisentry.getKey()).equals(selecteditems.get(i))) {
                            setList.add(thisentry.getValue());
                        }
                    }
                }
                ...
                ArrayList<String> list = new ArrayList<>(interset);
